...
### 3) 데이터 유형 변환
 ...
 <math>G = \begin{bmatrix} cos(\theta_1+\theta_1)&\cdots&cos(\theta_1+\theta_n)\\\vdots&\ddots&\vdots\\cos(\theta_n+\theta_1)&\cdots&cos(\theta_n+\theta_n)\end{bmatrix}</math>
...
<img width="60%" src = "https://github.com/GayoungLee09/FL01/assets/81952512/b08b6355-7e24-4696-be2c-a99c23feed09" />
(데이터 유형 변환 과정)
<br/>
<br/>
